...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "Numbers - Win32 Debug"
CPP=cl.exe
RSC=rc.exe
...
ALL : "$(OUTDIR)\Numbers.exe"

CLEAN : 
	-@erase "$(INTDIR)\Numbers.obj"
	-@erase "$(OUTDIR)\Numbers.exe"
...
# ADD CPP /nologo /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /Fp"..\TempCR/Multithd.pch" /YX"windows.h" /c
...
"$(OUTDIR)\Numbers.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\Numbers.exe"
	-@erase "$(OUTDIR)\Numbers.ilk"
	-@erase "$(OUTDIR)\Numbers.pdb"
...
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /Fp"..\TempCD/Multithd.pch" /YX"windows.h" /c
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /Fp"$(INTDIR)/Multithd.pch" /YX"windows.h" /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\..\TempCD/
CPP_SBRS=.\.
...
"$(INTDIR)\Numbers.obj" : $(SOURCE) "$(INTDIR)"

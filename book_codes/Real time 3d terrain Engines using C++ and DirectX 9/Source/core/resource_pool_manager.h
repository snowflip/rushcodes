...
enum VIDEO_RESOURCES
{
	...
	k_nIBufferResource,
	k_nRenderResource,
	k_nRenderSetResource,
	k_nModelResource,
	k_nImageResource,
	k_nSMaterialResource,
...
-----------------------------------------------------------------
    ...
    The Resource Pool Manager is the central resource system
	All resources can be created and managed through this interface
    
-----------------------------------------------------------------
*/
class cResourcePoolInterface;
#define ResourceManager cResourcePoolManager::instance()

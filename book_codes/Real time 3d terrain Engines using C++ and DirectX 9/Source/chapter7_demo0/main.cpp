...
HRESULT cMyHost::renderScene()
{
	...
	// tessellate all terrain sections queued
	m_terrainSystem.processTessellationQueue();

	// render all objects, including the newly
	// tessellated ROAM sections.
	// (puts them in the render queue)

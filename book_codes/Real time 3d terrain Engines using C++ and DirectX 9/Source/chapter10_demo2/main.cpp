...
HRESULT cMyHost::InitDeviceObjects()
{
	...
	m_skyDome.create(cSkyModel::k_dome);
	...
	m_pSkyMethod->loadEffect(
		cRenderMethod::k_defaultMethod,
		"media\\shaders\\simple_skydome.fx");
	...
	m_pSkyMap->loadResource("media\\textures\\sky_box2.dds");
	...
	m_pSkyMaterial->setTexture(1, m_pSkyClouds);
